...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/shy-butterfly-63de#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shy-butterfly-63de
```

A live public deployment of this template is available at [https://shy-butterfly-63de.templates.workers.dev](https://shy-butterfly-63de.templates.workers.dev)
